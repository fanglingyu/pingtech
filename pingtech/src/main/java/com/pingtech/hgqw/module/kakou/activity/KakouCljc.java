...
public class KakouCljc extends BaseActivity {
	private final String TAG = "KakouCljc";
	...
	protected void onCreate(Bundle savedInstanceState) {
		Log.i(TAG, "onCreate()");
		String title = getString(R.string.kakoumanager) + ">" + getString(R.string.readcard_cljc_kakou);
	...
	protected void find() {
		...
		clzjxxDetileFragment = new ClzjxxDetileFragment(this, handler, ManagerFlag.PDA_KKGL_CLYZ);
...
//		fragmentTransaction.hide(clzjxxDetileFragment);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case ReadService.READ_TYPE_SDSR:
				dealCard(msg);
				break;
			case KakouRequest.HANDLER_WHAT_DEALREADCARDINFO_FALSE:
			case KakouRequest.HANDLER_WHAT_DEALREADCARDINFO_TRUE:
				updateDealFlag(msg.what);
				break;
			case KakouRequest.HANDLER_WHAT_SDBC:
				sdbc(msg);
				break;
			case KakouRequest.HANDLER_WHAT_DETAIL:
				detail2((CardInfo) msg.obj, false, msg.arg1);
				break;
			case KakouRequest.HANDLER_WHAT_JLYC:
				detailJlyc(msg);
				break;
			case BUTTON_EVENT_BACK:
				back();
				break;
			case KakouRequest.HANDLER_WHAT_XGTXFX_SUCCESS:
				xgtxfxSuccess();
				break;
			default:
				break;
	...
	protected void dealCard(Message msg) {
		...
		new KakouRequest(this, handler).requestInspectClForKk(cardInfo, false);
...
//		detail2(cardInfo, true, 0);
		...
		clzjxxDetileFragment.xgtxfxSuccess(this);
...
//	}
	...
	protected void sdbc(Message msg) {
		Intent intent = new Intent(this, KakouClglSdbc.class);
		intent.putExtra("from", ManagerFlag.PDA_KKGL_CLYZ);
		intent.putExtra("cardInfo", (CardInfo) msg.obj);
		startActivity(intent);
//		setEachContentView(R.layout.kakou_clgl_activity);
	}
