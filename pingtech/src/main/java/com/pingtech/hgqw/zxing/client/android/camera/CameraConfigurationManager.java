...
import com.pingtech.hgqw.zxing.PreferencesActivity;
...
final class CameraConfigurationManager {
	...
	void setDesiredCameraParameters(Camera camera, boolean safeMode,boolean isLight) {
		Camera.Parameters parameters = camera.getParameters();
		...
		initializeTorch(parameters, prefs, safeMode,isLight);
	...
	// }
	private void initializeTorch(Camera.Parameters parameters, SharedPreferences prefs, boolean safeMode,boolean isLight) {
		boolean currentSetting = isLight;
		doSetTorch(parameters, currentSetting, safeMode);
	}
