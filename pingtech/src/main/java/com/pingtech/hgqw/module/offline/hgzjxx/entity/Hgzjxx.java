...
public class Hgzjxx {
	...
	/** 是否为一卡通，0不是，1是 */
	@DatabaseField(useGetSet = true, columnName = "isykt")
	private String isykt;

	/** 办证口岸代码 */
	@DatabaseField(useGetSet = true, columnName = "bzkadm")
	private String bzkadm;

	/** 办证口岸名称 */
	@DatabaseField(useGetSet = true, columnName = "bzkamc")
	private String bzkamc;
	...
	@DatabaseField(useGetSet = true, columnName = "clsbdh")
	private String clsbdh;

	@DatabaseField(useGetSet = true, columnName = "lxfs")
	private String lxfs;

	/** 区域类型标识 证件类别为限定区域通行证的有值（0表示人员，1表示车辆）否则为null */
	@DatabaseField(useGetSet = true, columnName = "qylxbs")
	private String qylxbs;
	...
	public String getQylxbs() {
		return qylxbs;
	}

	public void setQylxbs(String qylxbs) {
		this.qylxbs = qylxbs;
	}
	...
	public String getIsykt() {
		return isykt;
	}

	public void setIsykt(String isykt) {
		this.isykt = isykt;
	}

	public String getBzkadm() {
		return bzkadm;
	}

	public void setBzkadm(String bzkadm) {
		this.bzkadm = bzkadm;
	}

	public String getBzkamc() {
		return bzkamc;
	}

	public void setBzkamc(String bzkamc) {
		this.bzkamc = bzkamc;
	}
