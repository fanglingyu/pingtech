 ...
 * 
 * */
public class CfzgShipBindList extends CfzgSuperActivity implements OnHttpResult {
	...
	public void onCreate(Bundle savedInstanceState) {
		Log.i(TAG, "onCreate()");
		super.onCreateForCfzg(savedInstanceState, R.layout.shipbind_list);
	...
	public void onHttpResult(String str, int httpRequestType) {
		...
		if (HTTPREQUEST_TYPE_FOR_BINDSHIP == httpRequestType) {
			...
			if (str != null && ("1".equals(str) || "2".equals(str))) {
				...
				HgqwToast.makeText(CfzgShipBindList.this, R.string.bindship_success, HgqwToast.LENGTH_LONG).show();
				finish();
			} else if (str != null && "3".equals(str)) {
				HgqwToast.makeText(CfzgShipBindList.this, R.string.had_bind_ship, HgqwToast.LENGTH_LONG).show();
			} else {
				HgqwToast.makeText(CfzgShipBindList.this, R.string.bindship_failure, HgqwToast.LENGTH_LONG).show();
		...
		public void handleMessage(Message msg) {
			...
			case ShipBindAdapter.POSITIONZERO:
				...
				if (fromType == GlobalFlags.LIST_TYPE_FROM_KAKOUMANAGER) {
					...
					progressDialog = new ProgressDialog(CfzgShipBindList.this);
					progressDialog.setTitle(getString(R.string.waiting));
					progressDialog.setMessage(getString(R.string.waiting));
					progressDialog.setCancelable(false);
					progressDialog.setIndeterminate(false);
					progressDialog.show();
					NetWorkManager.request(CfzgShipBindList.this, url, params, HTTPREQUEST_TYPE_FOR_BINDSHIP);
				} else {
