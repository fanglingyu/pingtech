...
public class SimpleThumbnailAdapter extends SimpleAdapter {
	...
	public SimpleThumbnailAdapter(Context context, List<? extends Map<String, ?>> data, int layout, String[] from, int[] to, int[] imageIDs) {
	...
	private void setViewImageAndTag(ImageView v, String value, Drawable defaultImage) {
